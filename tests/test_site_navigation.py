...
class SiteNavigationTests(unittest.TestCase):
    ...
    def test_localized_system_pages_describe_v1_18_capabilities(self) -> None:
        pages = []
        for locale in ("zh", "en", "ja"):
            ...
            self.assertIn('id="paper-repository-title"', page)
        self.assertEqual([page.count('class="component-section"') for page in pages], [6, 6, 6])
